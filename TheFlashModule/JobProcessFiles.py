...
class JobProcessFiles():
  def __init__(
      self,
      directory_plt, dict_sim_inputs, list_spect_datasets,
    ...
    self.num_procs    = int(dict_sim_inputs["res_folder"]) // 6
    ...
    self.job_tagname  = FlashData.getJobTag(dict_sim_inputs, "plt")
