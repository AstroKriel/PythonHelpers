...
from jormi.ww_fields.fields_2d import (
    field_models as field_models_2d,
)
from jormi.ww_fields.fields_3d import (
    domain_models as domain_models_3d,
    field_models as field_models_3d,
    slice_fields,
)
...
class TestUniformDomain(unittest.TestCase):

    def _make_uniform_domain_3d(
        self,
    ) -> domain_models_3d.UniformDomain_3D:
        return domain_models_3d.UniformDomain_3D(
    ...
    def test_constructs_sliced_domain_axis_x0(
        ...
        uniform_domain_3d = self._make_uniform_domain_3d()
        uniform_domain_2d = slice_fields._slice_3d_uniform_domain(
        ...
        self.assertEqual(
            uniform_domain_2d.slice_index,
            1,
        )
        self.assertAlmostEqual(
            uniform_domain_2d.slice_position,
            1.5,
        )
    ...
    def test_rejects_negative_slice_index(
        ...
        with self.assertRaises(ValueError):
            slice_fields._slice_3d_uniform_domain(
                uniform_domain_3d=uniform_domain_3d,
                out_of_plane_axis="x0",
                slice_index=-1,
                param_name="<uniform_domain_3d>",
...
class TestScalarField(unittest.TestCase):
    ...
    def _make_sfield_3d(
        self,
    ) -> field_models_3d.ScalarField_3D:
        uniform_domain_3d = self._make_uniform_domain_3d()
    ...
    def test_slices_axis_x0(
        ...
        sarray_3d = field_models_3d.extract_3d_sarray(sfield_3d=sfield_3d)
        sarray_2d = field_models_2d.extract_2d_sarray(sfield_2d)
        self.assertEqual(
            sarray_2d.shape,
            (4, 5),
        )
...
class TestVectorField(unittest.TestCase):
    ...
    def _make_vfield_3d(
        self,
    ) -> field_models_3d.VectorField_3D:
        uniform_domain_3d = self._make_uniform_domain_3d()
    ...
    def test_slices_inplane_axis_x0(
        ...
        varray_3d = field_models_3d.extract_3d_varray(vfield_3d=vfield_3d)
        varray_2d = field_models_2d.extract_2d_varray(vfield_2d)
        self.assertEqual(
            varray_2d.shape,
            (2, 4, 5),
        )
