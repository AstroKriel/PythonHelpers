...
class TestHalfMasks2D(unittest.TestCase):
    ...
    def _check_mask_inverse(
        ...
        num_rows: int,
        num_cols: int,
        side_a: box_positions.Positions.Box.Side,
        side_b: box_positions.Positions.Box.Side,
    ) -> None:
    ...
    def test_top_bottom_complement_odd(
        ...
        self._check_mask_inverse(
            num_rows=5,
            num_cols=6,
            side_a=box_positions.Positions.Box.Side.Top,
            side_b=box_positions.Positions.Box.Side.Bottom,
        )
    ...
    def test_left_right_complement_odd(
        ...
        self._check_mask_inverse(
            num_rows=5,
            num_cols=5,
            side_a=box_positions.Positions.Box.Side.Left,
            side_b=box_positions.Positions.Box.Side.Right,
        )
    ...
    def test_top_covers_correct_rows(
        ...
        mask = mask_2d_arrays.HalfMasks2D.get_mask(
            num_rows=5,
            num_cols=4,
            anchor=box_positions.Positions.Box.Side.Top,
        )
    ...
    def test_left_covers_correct_cols(
        ...
        mask = mask_2d_arrays.HalfMasks2D.get_mask(
            num_rows=4,
            num_cols=6,
            anchor=box_positions.Positions.Box.Side.Left,
        )
        self.assertTrue(numpy.all(mask[:, :3]))
        self.assertTrue(numpy.all(~mask[:, 3:]))
    ...
    def test_output_shape(
        ...
        mask = mask_2d_arrays.HalfMasks2D.get_mask(
            num_rows=3,
            num_cols=7,
            anchor=box_positions.Positions.Box.Side.Right,
        )
        self.assertEqual(
            mask.shape,
            (3, 7),
...
class TestQuadrantMasks2D(unittest.TestCase):
    ...
    def _all_quadrants(
        ...
        return [
            mask_2d_arrays.QuadrantMasks2D.get_mask(
                ...
                box_positions.Positions.Box.Corner.TopLeft,
                box_positions.Positions.Box.Corner.TopRight,
                box_positions.Positions.Box.Corner.BottomLeft,
                box_positions.Positions.Box.Corner.BottomRight,
            )
        ]
    ...
    def test_top_left_position(
        ...
        mask = mask_2d_arrays.QuadrantMasks2D.get_mask(
            num_rows=5,
            num_cols=6,
            anchor=box_positions.Positions.Box.Corner.TopLeft,
        )
    ...
    def test_output_shape(
        ...
        mask = mask_2d_arrays.QuadrantMasks2D.get_mask(
            num_rows=4,
            num_cols=7,
            anchor=box_positions.Positions.Box.Corner.BottomRight,
        )
        self.assertEqual(
            mask.shape,
            (4, 7),
...
class TestWedgeMasks2D(unittest.TestCase):
    ...
    def test_all_four_wedges_cover_full_grid(
        ...
        mask_bottom = mask_2d_arrays.WedgeMasks2D.get_mask(
            num_rows=5,
            num_cols=5,
            anchor=box_positions.Positions.Box.Side.Bottom,
        )
