...
def add_text(
    ...
    y_pos: float,
    label: str,
    x_alignment: box_positions.Positions.PositionLike = box_positions.Positions.Box.Center.Center,
    y_alignment: box_positions.Positions.PositionLike = box_positions.Positions.Box.Center.Center,
    text_size: float = 20,
...
def add_custom_legend(
    ...
    anchor_at_corner: box_positions.Positions.PositionLike = box_positions.Positions.Box.Corner.TopRight,
