...
class ScalarField_2D(_fields.Field):
    ...
    def from_2d_sarray(
        ...
        *,
        ...
        _fdata.ensure_2d_sarray(
            sarray_2d=sarray_2d,
            param_name="<sarray_2d>",
        )
        sdata_2d = _fdata.ScalarFieldData_2D(
            farray=sarray_2d,
            param_name="<sdata_2d>",
        )
        return cls(
...
class VectorField_2D(_fields.Field):
    ...
    def from_2d_varray(
        ...
        *,
        ...
        _fdata.ensure_2d_varray(
            varray_2d=varray_2d,
            param_name="<varray_2d>",
        )
        vdata_2d = _fdata.VectorFieldData_2D(
            farray=varray_2d,
            param_name="<vdata_2d>",
        )
        return cls(
