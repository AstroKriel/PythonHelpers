    ...
    def from_3d_sarray(
        ...
        *,
        ...
        return cls._from_farray(
            ...
            sim_time=sim_time,
            fdata_fn=_fdata.ScalarFieldData_3D,
    ...
    def from_3d_varray(
        ...
        *,
        ...
        return cls._from_farray(
            ...
            field_label=field_label,
            sim_time=sim_time,
            fdata_fn=_fdata.VectorFieldData_3D,
...
class UnitVectorField_3D(VectorField_3D):
    ...
    def _validate_unit_magnitude(
        ...
        ## validate here, rather than in the _fdata module, since the following
...
def extract_3d_sarray(
    ...
    *,
    ...
    return _fdata.extract_3d_sarray(
...
def extract_3d_varray(
    ...
    *,
    ...
    return _fdata.extract_3d_varray(
