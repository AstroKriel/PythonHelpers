...
def compute_vfield_dot_product(
    *,
    vfield_3d_a: field_type.VectorField_3D,
    vfield_3d_b: field_type.VectorField_3D,
    field_label: str = "a_i b_i",
) -> field_type.ScalarField_3D:
    """Compute the dot product a_i b_i cellwise for two 3D vector field_type."""
    ...
    varray_3d_a = field_type.extract_3d_varray(
...
def compute_vfield_cross_product(
    *,
    ...
    """Compute the cross product epsilon_ijk a_j b_k cellwise for two 3D vector field_type."""
    field_type.ensure_same_3d_field_udomains(
        field_3d_a=vfield_3d_a,
        field_3d_b=vfield_3d_b,
        field_name_a="<vfield_3d_a>",
