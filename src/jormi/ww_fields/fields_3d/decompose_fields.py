...
class HelmholtzDecomposedFields_3D:
    vfield_3d_div: field_type.VectorField_3D
    vfield_3d_sol: field_type.VectorField_3D
    vfield_3d_bulk: field_type.VectorField_3D
...
def compute_helmholtz_decomposed_fields(
    vfield_3d_q: field_type.VectorField_3D,
    ...
    domain_type.ensure_3d_periodic_udomain(
        udomain_3d=udomain_3d,
        param_name="<udomain_3d>",
    )
    varray_3d_q = field_type.extract_3d_varray(
        vfield_3d=vfield_3d_q,
        param_name="<vfield_3d_q>",
    )
    ...
    vfield_3d_div = field_type.VectorField_3D.from_3d_varray(
        varray_3d=hd_3d_farrays.varray_3d_div,
        udomain_3d=udomain_3d,
        field_label="f_{i,div}",
        sim_time=sim_time,
    )
    vfield_3d_sol = field_type.VectorField_3D.from_3d_varray(
        varray_3d=hd_3d_farrays.varray_3d_sol,
        udomain_3d=udomain_3d,
        field_label="f_{i,sol}",
        sim_time=sim_time,
    )
    vfield_3d_bulk = field_type.VectorField_3D.from_3d_varray(
...
class TNBDecomposedFields_3D:
    uvfield_3d_tangent: field_type.UnitVectorField_3D
    uvfield_3d_normal: field_type.UnitVectorField_3D
    uvfield_3d_binormal: field_type.UnitVectorField_3D
    sfield_3d_curvature: field_type.ScalarField_3D

    def __post_init__(
        self,
    ) -> None:
        field_type.ensure_3d_uvfield(
...
def compute_tnb_decomposed_fields(
    ...
    *,
    ...
    vfield_3d_tangent = field_type.VectorField_3D.from_3d_varray(
        varray_3d=tnb_3d_farrays.uvarray_3d_tangent,
        udomain_3d=udomain_3d,
        field_label="t_i",
        sim_time=sim_time,
    )
    vfield_3d_normal = field_type.VectorField_3D.from_3d_varray(
        varray_3d=tnb_3d_farrays.uvarray_3d_normal,
        udomain_3d=udomain_3d,
        field_label="n_i",
        sim_time=sim_time,
    )
    vfield_3d_binormal = field_type.VectorField_3D.from_3d_varray(
    ...
    uvfield_3d_tangent = field_type.as_3d_uvfield(
        vfield_3d=vfield_3d_tangent,
    )
    uvfield_3d_normal = field_type.as_3d_uvfield(
        vfield_3d=vfield_3d_normal,
    )
    uvfield_3d_binormal = field_type.as_3d_uvfield(
...
class MagneticCurvatureFields_3D:
    sfield_3d_curvature: field_type.ScalarField_3D
    sfield_3d_stretching: field_type.ScalarField_3D
    sfield_3d_compression: field_type.ScalarField_3D
...
def compute_magnetic_curvature_decomposed_fields(
    *,
    ...
    uvarray_3d_tangent = field_type.extract_3d_varray(
        vfield_3d=uvfield_3d_tangent,
        param_name="<uvfield_3d_tangent>",
    )
    uvarray_3d_normal = field_type.extract_3d_varray(
...
class LorentzForceFields_3D:
    vfield_3d_lorentz: field_type.VectorField_3D
    vfield_3d_tension: field_type.VectorField_3D
    vfield_3d_gradP_perp: field_type.VectorField_3D
