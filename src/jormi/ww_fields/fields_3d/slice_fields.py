...
from jormi.ww_types import type_manager, sequence_positions
from jormi.ww_fields import _cartesian_coordinates
from jormi.ww_fields.fields_2d import (
    domain_types as _2d_domain_types,
    field_types as _2d_field_types,
)
from jormi.ww_fields.fields_3d import (
    domain_types as _3d_domain_types,
...
def _slice_3d_udomain(
    *,
    udomain_3d: _3d_domain_types.UniformDomain_3D,
    out_of_plane_axis: _cartesian_coordinates.AxisLike,
    slice_index: int,
    param_name: str = "<udomain_3d>",
) -> _2d_domain_types.UniformDomain_2D_Sliced3D:
    ...
    return _2d_domain_types.UniformDomain_2D_Sliced3D(
...
def slice_3d_sfield(
    *,
    sfield_3d: _3d_field_types.ScalarField_3D,
    out_of_plane_axis: _cartesian_coordinates.AxisLike,
    slice_index: int,
    field_label: str | None = None,
) -> _2d_field_types.ScalarField_2D:
    """
    ...
    """
    _3d_field_types.ensure_3d_sfield(sfield_3d)
    sarray_3d = _3d_field_types.extract_3d_sarray(sfield_3d)
    ...
    return _2d_field_types.ScalarField_2D.from_2d_sarray(
        sarray_2d=sarray_2d,
...
def slice_3d_vfield_inplane(
    *,
    vfield_3d: _3d_field_types.VectorField_3D,
    out_of_plane_axis: _cartesian_coordinates.AxisLike,
    slice_index: int,
    field_label: str | None = None,
) -> _2d_field_types.VectorField_2D:
    """
    ...
    """
    _3d_field_types.ensure_3d_vfield(vfield_3d)
    varray_3d = _3d_field_types.extract_3d_varray(vfield_3d)
    ...
    return _2d_field_types.VectorField_2D.from_2d_varray(
        varray_2d=varray_2d,
        udomain_2d=udomain_2d,
        field_label=field_label,
        sim_time=sim_time,
