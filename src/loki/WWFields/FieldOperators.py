...
def compute_vfield_curl(vfield_q, box_width=1.0, grad_order=2):
  grad_func = _lookup_grad_func(grad_order)
...
def compute_sfield_gradient(sfield_q, box_width=1.0, grad_order=2):
  grad_func = _lookup_grad_func(grad_order)
