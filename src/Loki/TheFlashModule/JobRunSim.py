...
from Loki.TheFlashModule import FlashData, FileNames, LoadData
...
class JobRunSim():
  ...
  def _defineJobParams(self):
    ...
    self.job_tagname = FlashData.getJobTag(self.dict_sim_config, "sim")
  ...
  def prepFromReference(self, filepath_ref_sim):
    ...
    ref_sim_input = FlashData.readSimConfig(filepath_ref_sim, bool_verbose=False)
    ...
    FlashData.saveSimConfig(self.directory_sim, self.dict_sim_config)
