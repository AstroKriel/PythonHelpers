...
from jormi.ww_fields.fields_3d import domain_type
...
class TestProperties(unittest.TestCase):
    ...
    def test_cell_centers_shapes_and_values(self):
        ...
        self.assertTrue(numpy.allclose(x2_centers, expected_x2))
...
class TestEnsureHelpers(unittest.TestCase):
    ...
    def test_ensure_3d_udomain_accepts(self):
        ...
        domain_type.ensure_3d_udomain(udomain_3d=udomain_3d)

    def test_ensure_3d_udomain_rejects_wrong_type(self):
        with self.assertRaises(TypeError):
            domain_type.ensure_3d_udomain(udomain_3d=None)  # type: ignore[arg-type]
    ...
    def test_ensure_3d_periodic_udomain_accepts_fully_periodic(self):
        ...
        domain_type.ensure_3d_periodic_udomain(udomain_3d=udomain_3d)
